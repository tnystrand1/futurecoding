...
export const formatCourseContextForAI = (courseContext, currentTime) => {
  ...
  if (currentActivity) {
    ...
    context += `• Help with tasks related to this specific activity\n`;
    context += `• Reference the activity context in your responses\n`;
    context += `• Guide them toward the learning goals of this activity\n`;
    context += `• Be aware of time constraints for this activity\n\n`;
  }
