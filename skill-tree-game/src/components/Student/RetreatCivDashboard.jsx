...
const RetreatCivDashboard = () => {
  ...
  // Check if this student is allowed in retreat dashboard
  const ALLOWED_STUDENTS = ['tim', 'miles', 'gus', 'sample_student'];
  const isAllowedStudent = ALLOWED_STUDENTS.includes(studentId);
  ...
  // Redirect if student is not allowed
  if (!loading && !isAllowedStudent) {
    return (
      <div style={{
        minHeight: '100vh',
        ...
        <div>
          ...
          <p>This student profile is not authorized for the retreat dashboard.</p>
          <a 
            href="/" 
            style={{ 
              color: '#F4E4BC', 
  ...
  // Get student's team - simplified for retreat (all same team)
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ width: '300px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {/* XP Leaderboard - Limited to retreat participants */}
          <XPLeaderboard 
        ...
        {/* Center - Main Skill Tree (same as original) */}
        <div style={{ flex: 1 }}>
          <div style={{ 
            background: 'linear-gradient(135deg, #F4E4BC 0%, #E6D5A8 100%)',
            border: '3px solid #8B4513',
      ...
      {/* All the modals - same as original CivDashboard */}
      ...
      {/* Resources Modal - same as original */}
      {showResourcesModal && (
        <div style={{
          position: 'fixed',
          top: 0,
...
export default RetreatCivDashboard;
